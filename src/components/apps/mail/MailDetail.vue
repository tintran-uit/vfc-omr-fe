...
<template>
  ...
  <div class="py-3 d-flex ga-4">
    <v-btn color="primary" variant="outlined"><EditFilled class="me-1" /> Reply</v-btn>
    <v-btn color="primary" variant="outlined"><ForwardFilled class="me-1" :style="{ fontSize: '18px' }" /> Forward</v-btn>
  </div>
</template>
