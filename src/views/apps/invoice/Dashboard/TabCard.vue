                ...
                <v-card-text>
                  <div class="d-flex align-start justify-space-between">
                    ...
                    <div class="d-flex align-center">
                      ...
                      <h5 class="text-h5 text-lightText mb-0 ms-1">20.3%</h5>
                    </div>
                  </div>
                </v-card-text>
              </v-card>
                ...
                <v-card-text>
                  <div class="d-flex align-start justify-space-between">
                    ...
                    <div class="d-flex align-center">
                      ...
                      <h5 class="text-h5 text-lightText mb-0 ms-1">-8.73%</h5>
                    </div>
                  </div>
                </v-card-text>
              </v-card>
                ...
                <v-card-text>
                  <div class="d-flex align-start justify-space-between">
                    ...
                    <div class="d-flex align-center">
                      ...
                      <h5 class="text-h5 text-lightText mb-0 ms-1">1.73%</h5>
                    </div>
                  </div>
                </v-card-text>
              </v-card>
                ...
                <v-card-text>
                  <div class="d-flex align-start justify-space-between">
                    ...
                    <div class="d-flex align-center">
                      ...
                      <h5 class="text-h5 text-lightText mb-0 ms-1">-4.7%</h5>
                    </div>
                  </div>
                </v-card-text>
              </v-card>
